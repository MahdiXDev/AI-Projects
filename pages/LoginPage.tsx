...
const LoginPage: React.FC = () => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        try {
            ...
            const userIndex = storedUsers.findIndex((u: any) => u.email === email && u.password === password);
            
            if (userIndex > -1) {
                const user = storedUsers[userIndex];
                
                // Backfill data for old users
                    ...
                    <div className="rounded-md shadow-sm -space-y-px">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="appearance-none rounded-b-lg relative block w-full pl-16 pr-3 py-2 border border-gray-400 dark:border-gray-600 bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-sky-500 focus:border-sky-500 focus:z-10 sm:text-sm"
