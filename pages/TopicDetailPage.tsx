...
const TopicDetailPage: React.FC = () => {
  ...
  if (!course || !topic) {
    return <div className="text-center text-red-400">Topic not found.</div>;
  }
    ...
    <div>
      <header className="mb-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="mt-1 text-gray-400">Notes and resources for this topic.</p>
            </div>
            {isDirty && (
                <button
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="rounded-xl border border-white/10 bg-gray-800/40 p-6 shadow-lg">
          <label htmlFor="notes" className="block text-lg font-semibold text-white mb-3">Notes</label>
          <textarea
            id="notes"
            value={notes}
        ...
        {/* Image Uploader */}
        <div className="rounded-xl border border-white/10 bg-gray-800/40 p-6 shadow-lg">
          <h2 className="text-lg font-semibold text-white mb-3">Associated Image</h2>
